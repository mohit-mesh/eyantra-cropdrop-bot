...
| Task | Objective | Deliverables / Media Links |
| :--- | :--- | :--- |
| **Task 3A** | Physical arena preparation (Flex printing and spatial calibration). | [View Setup Photo](#) *(Paste image link here)* |
| **Task 3B** | Complete physical assembly of the robot (chassis, motors, sensors). | [View Assembly Photo](#) |
