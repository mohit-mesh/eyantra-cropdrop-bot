...
### Phase 1: Simulation & Basic Control
| Task | Objective | Deliverables / Media Links |
| :--- | :--- | :--- |
| **Task 0** | Introduction to CoppeliaSim environment and basic API interactions. |
| **Task 1A** | Basic locomotion and kinematics implementation in simulation. | [Watch Video](https://youtu.be/E3lrXw1rDbM) |
| **Task 1B** | Sensor integration (vision/proximity) within the CoppeliaSim scene. | [Watch Video](https://youtu.be/_9AlKNXZCRw) |

### Phase 2: Autonomous Navigation (Simulation)
| Task | Objective | Deliverables / Media Links |
| :--- | :--- | :--- |
| **Task 2A** | Implementation of path planning algorithms in simulation. | [Watch Video](https://youtu.be/VgObchYK7ao) |
| **Task 2B** | Advanced obstacle avoidance and dynamic path replanning. | [Watch Video](https://youtu.be/pBu2Rf4UkDo) |

### Phase 3: Hardware Assembly & Setup
| Task | Objective | Deliverables / Media Links |
| :--- | :--- | :--- |
| **Task 3A** | Physical arena preparation (Flex printing and spatial calibration). | [View Setup Photo](<img width="960" height="1280" alt="Arena" src="https://github.com/user-attachments/assets/3c4ab6ad-a680-40f6-8e17-0341b8b163ab" />
) |
| **Task 3B** | Complete physical assembly of the robot (chassis, motors, sensors). | [View Assembly Photo](<img width="1079" height="1035" alt="Bot" src="https://github.com/user-attachments/assets/0258c1a4-a000-4a13-9225-5e72e98cf3ce" />
) |
...
*Note: All corresponding source code for these tasks can be found in the respective task folders within the main repository.*
